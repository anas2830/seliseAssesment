...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="right badge badge-success"> @if(Auth::guard('admin')->check()) Admin @else Moderator @endif</span>
      </span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link @if($activeMenu == 'moderator' || $activeMenu == 'home' || $activeMenu == 'blog-post' ) active @endif">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="@if(Auth::guard('admin')->check()) {{ url('/dashboard') }} @else {{ url('/moderatorDashboard') }} @endif" class='nav-link @if($activeMenu == "home") active @endif'>
              ...
              <li class="nav-item">
                <a href="@if(Auth::guard('admin')->check()) {{ url('handleBlogAdmin') }} @else {{ url('handleBlogModerator') }} @endif" class='nav-link @if($activeMenu == "blog-post") active @endif'>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Blog Post</p>
                </a>
              </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
          <li class="nav-item">
            <a class='nav-link @if($activeMenu == "profile") active @endif' href="@if(Auth::guard('admin')->check()) {{ url('adminProfile') }} @else {{ url('moderatorProfile') }} @endif">
